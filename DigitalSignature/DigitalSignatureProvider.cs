...
namespace DigitalSignature
{
    ...
    public class DigitalSignatureProvider : IDigitalSignatureProvider
    {
        ...
        //DES默认密钥向量
        private static readonly byte[] DES_IV = { 0x12, 0x34, 0x56, 0x78, 0x90, 0xAB, 0xCD, 0xEF };
        //AES默认密钥向量   
        ...
        /// <param name="input"></param>
        /// <returns></returns>
        public string EncryptBySHA1(string input)
        {
        ...
        /// <returns></returns>
        public string EncryptByDES(string input, string key)
        {
        ...
        /// <returns></returns>
        public byte[] EncryptByDES(byte[] inputBytes, byte[] key, byte[] IV)
        {
        ...
        /// <param name="key"></param>
        /// <returns></returns>
        public string DecryptByDES(string input, string key)
        {
        ...
        /// <param name="iv"></param>
        /// <returns></returns>
        public byte[] DecryptByDES(byte[] inputBytes, byte[] key, byte[] iv)
        {
        ...
        /// <returns></returns>
        public string EncryptString(string input, string sKey)
        {
        ...
        /// <param name="sKey"></param>
        /// <returns></returns>
        public string DecryptString(string input, string sKey)
        {
        ...
        /// <returns></returns> 
        public byte[] EncryptByAES(byte[] inputdata, byte[] key, byte[] iv)
        {
            ////分组加密算法 
        ...
        /// <returns></returns> 
        public byte[] DecryptByAES(byte[] inputBytes, byte[] key, byte[] iv)
        {
            Aes aes = new AesCryptoServiceProvider();
            aes.Key = key;
            aes.IV = iv;
        ...
        /// </summary>
        /// <returns></returns>
        public KeyValuePair<string, string> CreateRSAKey()
        {
